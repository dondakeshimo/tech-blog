...
module.exports = {
  ...
  siteTitle: '[移行しました] (これは昔の)dondakeshimoの丸太',
  siteDescription: 'dondakeshimo.com をご参照ください',
  author: 'dondakeshimo',
  ...
  tags: {
    ...
    book: {
      description: 'Book is my book review.'
    },
    cpp: {
      description: 'Cpp is a very first and very uncontrollable language.'
    },
    DL: {
    ...
    java: {
      description: 'Java is Javathehat'
    },
    javascript: {
